...
// Cell buffer is ping-ponged so the active half can be rebuilt without
// overwriting the other half while GPU work from the previous frame drains.
// Stride is the total per-half size in reservoir entries.

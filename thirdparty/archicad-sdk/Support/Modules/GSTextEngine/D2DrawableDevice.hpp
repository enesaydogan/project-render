...
public:
	...
	D2DrawableDeviceContext (ID2D1RenderTarget* renderTarget, std::unordered_map<Gfx::Color, ID2D1SolidColorBrush*>* brushes, ID2D1Layer* clipLayer, std::vector<ID2D1PathGeometry*>* clipPolygons, GS::Rect<float> visibleRect);
};

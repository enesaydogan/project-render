...
public:
	...
	v1::BendDefault					GetBendDefault () const;
...
public:
	 ...
	 */
	void SetBendDefault (const v1::BendDefault& bendDefault) const;
...
using MEPAPI_VERSION::RoutingNodeDefault;
using MEPAPI_VERSION::CreateRoutingNodeDefault;

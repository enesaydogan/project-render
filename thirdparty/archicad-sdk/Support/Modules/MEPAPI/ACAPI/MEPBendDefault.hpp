...
public:
	...
	/** @return Returns the UniqueID of the PreferenceTable of a PipeBendDefault or a DuctBendDefault, in case of CableCarrierBendDefault returns Error. */
...
public:
	...
	/**
	 * @brief Sets the PreferenceTable of the BendDefault in the case of Duct and Pipe. This PreferenceTable will be transferred into the Bends when a route is placed or modified.
	 * @param tableId The UniqueID referring to the PreferenceTable to be set.
	 * @return Returns an error in the case of Cable Carrier Bend or if the referred ElbowTable can not be found, otherwise nothing.
	 */

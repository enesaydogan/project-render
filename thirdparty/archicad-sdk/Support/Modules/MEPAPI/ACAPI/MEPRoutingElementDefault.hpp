...
public:
	...
	/** @return Returns the RoutingSegmentDefault of the RoutingElementDefault.*/
	v1::RoutingSegmentDefault				GetRoutingSegmentDefault () const;
...
public:
	 ...
	 * @param routingSegmentDefault The default to be set.
	 */
	void		SetRoutingSegmentDefault (const v1::RoutingSegmentDefault& routingSegmentDefault);
...
using MEPAPI_VERSION::RoutingElementDefault;
using MEPAPI_VERSION::CreateRoutingElementDefault;
